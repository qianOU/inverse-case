...
class Text:
	def __init__(self, param='34748'):
		...
		self.url = 'http://www.scicol.shu.edu.cn/Default.aspx?tabid=34452'
		self.headers = {
...
def sci_graduate_main():
	...
	df.to_excel(excel_writer=r'./documents/研究生教育/理学院获取的有关数学研究生教育详细信息.xlsx',index = False)
	df = pd.Series(w.list_name)
	df.to_excel(excel_writer=r'./documents/研究生教育/理学院的有关数学研究生教育列表.xlsx',index = False)
